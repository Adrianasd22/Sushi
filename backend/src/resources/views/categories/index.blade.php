            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-slate-500 dark:text-slate-400 mt-0.5">
                        {{ $categories->count() }} categorías en total
                    </p>
                </div>
            ...
            <div class="bg-white dark:bg-slate-800
                ...
                @forelse ($categories as $category)
                    ...
                    <div class="flex items-center gap-4 px-5 py-4
                        ...
                        {{-- ICONO / INICIAL --}}
                        {{--
                            Un círculo con la inicial de la categoría.
                            Si tu modelo tiene un campo 'color' o 'icon' puedes usarlo aquí.
                        --}}
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            {{-- Contador de productos (requiere withCount en el controlador) --}}
                            @isset($category->products_count)
                                <p class="text-xs text-slate-400 dark:text-slate-500 mt-0.5">
                                    {{ $category->products_count }}
                                    {{ Str::plural('producto', $category->products_count) }}
                                </p>
                            @endisset
                        </div>
                        ...
                        <div class="flex items-center gap-2 shrink-0">
                            ...
                            <form action="{{ route('categories.destroy', $category) }}" method="POST"
                                  onsubmit="return confirm('¿Seguro que quieres eliminar «{{ $category->name }}»?\nSe desvincularán todos sus productos.')">
                                @csrf
                                @method('DELETE')
